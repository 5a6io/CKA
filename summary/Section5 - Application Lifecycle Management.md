...
![image.png](../images/Section5_-_Application_Lifecycle_Management/image1.png)
...
![image.png](../images/Section5_-_Application_Lifecycle_Management/image2.png)
...
![image.png](../images/Section5_-_Application_Lifecycle_Management/image3.png)
...
![image.png](../images/Section5_-_Application_Lifecycle_Management/image4.png)

1. webapp-color-2 디렉토리 안 두 파일 관찰. 컨테이너 시작 시 명령어. 디렉토리 안 Dockerfile로부터 만든 이미지라 가정.
→ —color green

![image.png](../images/Section5_-_Application_Lifecycle_Management/image5.png)


![image.png](../images/Section5_-_Application_Lifecycle_Management/image6.png)

1. webapp-color-3 디렉토리 안 두 파일 관찰. 컨테이너 시작 시 명령어. 디렉토리 안 Dockerfile로부터 만든 이미지라 가정.
→ python [app.py](http://app.py/) —color pink

![image.png](../images/Section5_-_Application_Lifecycle_Management/image7.png)


![image.png](../images/Section5_-_Application_Lifecycle_Management/image8.png)
...
![image.png](../images/Section5_-_Application_Lifecycle_Management/image9.png)


![image.png](../images/Section5_-_Application_Lifecycle_Management/image10.png)
...
![image.png](../images/Section5_-_Application_Lifecycle_Management/image11.png)
...
![image.png](../images/Section5_-_Application_Lifecycle_Management/image12.png)
